...
$market->addCurrency(new Cryptocurrency\Task1\Bitcoin(1));
$market->addCurrency(new Cryptocurrency\Task1\Ethereum(2));
$market->addCurrency(new Cryptocurrency\Task1\Dogecoin(3));
